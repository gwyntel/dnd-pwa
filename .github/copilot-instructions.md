...
**Maintenance Note**: As code changes are made, this file and CLINE.md should be updated to reflect new patterns, architectural shifts, or developer workflows so future AI agents remain aligned with the evolving codebase.
